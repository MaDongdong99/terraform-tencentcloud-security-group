...
# $group - Tencent Cloud Security Group Terraform module
## Usage
\`\`\`hcl
module "${group/-/_}_security_group" {
  source  = "terraform-tencentcloud-modules/security-group/tencentcloud//modules/${group}"
  version = "~> 2.0"
  # omitted...
}
\`\`\`
...
EOF
    ...
    list_of_modules=$(echo "$list_of_modules";  echo "* [$group](https://github.com/terraform-tencentcloud-modules/terraform-tencentcloud-security-group/tree/master/modules/$group)")
...
$list_of_modules
* [_templates](https://github.com/terraform-tencentcloud-modules/terraform-tencentcloud-security-group/tree/master/modules/_templates) - Source templates for all other modules. Change carefully, test thoughtfully!
EOF
